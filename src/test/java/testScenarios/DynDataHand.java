...
public class DynDataHand {
	...
	public void verifyDynData()
	{
		...
		boolean chkIsEnabled=driver.findElement(By.xpath("//*[@id=\"form\"]/input[2]")).isEnabled();
		System.out.println(chkIsEnabled);
		if(chkIsEnabled==true)
		{
